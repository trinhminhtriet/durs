...
set edit:completion:arg-completer[durs] = {|@words|
    fn spaces {|n|
    ...
    var completions = [
        &'durs'= {
            ...
            cand --files0-from 'run durs on NUL-terminated file names specified in file; if argument is -, then read names from standard input'
